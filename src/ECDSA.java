...
class ECDSA {
    ...
    public ECDSA() {
        ...
        // make keyPair and load default keys
        keyPair = new KeyPair(publicKey, privateKey);
        keyPair.genKeyPair();
        privateKey.setS(defaultPrivateKey, (short) 0, (short) defaultPrivateKey.length);
        publicKey.setW(defaultPublicKey, (short) 0, (short) defaultPublicKey.length);
    ...
    public void getConfig(APDU apdu) {
        ...
        switch(buffer[ISO7816.OFFSET_P1]) {
            case PAR_PRIVATE: le = privateKey.getS(buffer, (short) 0);         break;
            case PAR_PUBLIC:  le = publicKey.getW(buffer, (short) 0);          break;
            case PAR_FIELD:   le = publicKey.getField(buffer, (short) 0);      break;
            case PAR_A:       le = publicKey.getA(buffer, (short) 0);          break;
            case PAR_B:       le = publicKey.getB(buffer, (short) 0);          break;
            case PAR_G:       le = publicKey.getG(buffer, (short) 0);          break;
            case PAR_R:       le = publicKey.getR(buffer, (short) 0);          break;
            default:          ISOException.throwIt(ISO7816.SW_INCORRECT_P1P2); break;
        }
